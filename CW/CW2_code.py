...
df = pd.read_csv("CW_Data.csv", header=0)
...
# when writing classifier chapter, first split to training set and test set to see overfitting or underfitting
# when splitting training set and test do not use cv, when using cv then do not split.
